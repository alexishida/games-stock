# hardware-inventory - Especificacao

## Purpose
Define o inventario fisico de hardware: cadastro de itens (consoles, controles, acessorios), tipos e estados de conservacao configuráveis, galeria de fotos por item, grade de cards com busca e filtros, painel de detalhe/edicao e integracao com backup de dados.
