...
O sistema SHALL exibir uma barra de menu nativa com itens: MENU (importar jogos, configurações, sair), FERRAMENTAS, VISUALIZAÇÃO (grade/lista), ORGANIZADO POR, GRUPO DE IMAGENS, EMBLEMAS.
