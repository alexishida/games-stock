# hardware-inventory - Especificação

## Purpose
Define o inventário físico de hardware: cadastro de itens (consoles, controles, acessórios), tipos e estados de conservação configuráveis, galeria de fotos por item, grade de cards com busca e filtros, painel de detalhe/edição e integração com backup de dados.
